...
STRINGS.NAMES.YOSHINO_LUCKYSACHET = "幸运香囊"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.YOSHINO_LUCKYSACHET = "祝我好运" --检查四糸乃的幸运香囊时的通用台词
STRINGS.RECIPE_DESC.YOSHINO_LUCKYSACHET = "能装很多东西"   --配方上的描述，最多两行，共32个中文字符不含"\n"符号
