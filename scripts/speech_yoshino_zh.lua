return {
    ...
    DESCRIBE =      --检查描述
    {
        ...
        {
            LINE_1 = "我看不懂上面的文字，也许是某种古文字?",		--第一块
            LINE_2 = "要是有人能告诉我上面写着什么就好了",		--第二块
            LINE_3 = "我看不懂上面的文字，也许是某种古文字?",		--第三块
            LINE_4 = "要是有人能告诉我上面写着什么就好了",		--第四块
            LINE_5 = "我看不懂上面的文字，也许是某种古文字?",		--第五块
        },
		VAULT_RUNE = "我看不懂上面的文字，也许是某种古文字?",		--进漩涡之后，检查圣殿月符石
		VAULT_STATUE =		--圣殿月符石
		{
			LORE1 = "...这上面写了什么?",		--第一块
			LORE2 = "...这上面写了什么?",		--第二块
